...
const ExpenseDetailsHomePage: React.FC = () => {
  ...
  const url = YYYYMM
    ? `${process.env.REACT_APP_API_URL}/api/budget/info/bucketexpense/${bucketname}?YYYYMM=${YYYYMM}`
    : `${process.env.REACT_APP_API_URL}/api/budget/info/bucketexpense/${bucketname}`;
