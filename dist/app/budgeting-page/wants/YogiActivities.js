...
const YogiActivities = () => {
  ...
  (0, react_1.useEffect)(() => {
    axios_1.default
      .get('http://localhost:5000/budget/wants/Yogi-Activities')
      .then((response) => {
  ...
  return (0, jsx_runtime_1.jsxs)(
    ...
    {
      children: [
        (0, jsx_runtime_1.jsx)('h1', { children: 'YogiActivities' }, void 0),
        (0, jsx_runtime_1.jsx)(
          'p',
          {
        ...
        (0, jsx_runtime_1.jsx)(
          ...
          {
            children:
              data === null || data === void 0 ? void 0 : data.bucketName,
          },
          void 0,
        ),
        (0, jsx_runtime_1.jsx)(
          'p',
          { children: data === null || data === void 0 ? void 0 : data.budget },
          void 0,
        ),
      ],
    },
...
exports.default = YogiActivities;
