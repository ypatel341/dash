...
const CalendarTodayRounded_1 = __importDefault(
  require('@mui/icons-material/CalendarTodayRounded'),
);
    ...
    Object.assign(
      {
        ...
        size: 'small',
        onClick: () =>
          setOpen === null || setOpen === void 0
            ? void 0
            : setOpen((prev) => !prev),
        startIcon: (0, jsx_runtime_1.jsx)(
          CalendarTodayRounded_1.default,
          { fontSize: 'small' },
          void 0,
        ),
